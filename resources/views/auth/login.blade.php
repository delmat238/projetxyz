        ...
        <section class="block">
            ...
            <form method="post" action="{{route('login')}}" class="block-content space-y-4">
                ...
                <div>
                    ...
                    <input id="email" name="email" type="text" placeholder="email" class="w-full" autocomplete="email"
                           autofocus value="">
                </div>
            ...
            <form method="post" action="{{route('signup-account')}}" class="block-content space-y-4">
                @csrf
                <div>
